...
from xespresso.workflow.oer import OER_bulk, OER_surface, fix_layers, OER_pourbaix, OER_site
...
queue = {'nodes': 2, 'ntasks-per-node': 20, 'partition': 'bdw', 'mem-per-cpu': '5G', 'time': '23:59:00', 'config': '.xespresso-intel-2020b'}
parameters = {
...
#
calc = Espresso(label = 'relax/001-221-Pt',
                **parameters,
)
