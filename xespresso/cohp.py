...
class COHP:
    ...
    def run(self, cpu=1):
        ...
        """
        shutil.copy(
            os.path.join(self.directory, "%s.pwi" % self.prefix),
    ...
    def read_cohp(
        ...
        # read COHP results
        datas = np.genfromtxt(
            os.path.join(self.directory, "COHPCAR.lobster"),
        ...
        # read COOP results
        datas = np.genfromtxt(
            os.path.join(self.directory, "COOPCAR.lobster"),
            skip_header=3 + len(self.indexs),
        )
        self.coop = datas[:, 1]
        ...
        # read COBI results
        datas = np.genfromtxt(
            os.path.join(self.directory, "COBICAR.lobster"),
            skip_header=3 + len(self.indexs),
        )
        self.cobi = datas[:, 1]
    ...
    def read_icohp(
        ...
        # read icohp
        datas = np.genfromtxt(
            os.path.join(self.directory, "ICOHPLIST.lobster"),
        ...
        # read icoop
        datas = np.genfromtxt(
            os.path.join(self.directory, "ICOOPLIST.lobster"),
            dtype=[int, "S5", "S5", float, float],
            usecols=(0, 1, 2, 3, 7),
